...
ADJ['5'] = ['4','6','9']
ADJ['6'] = ['Dijon','Nancy']
ADJ['7'] = ['Strasbourg','Lyon','Paris','Nancy']
ADJ['8'] = ['Grenoble','Avignon','Limoges','Dijon']
ADJ['9'] = ['Avignon','Lyon']
ADJ['10'] = ['Grenoble','Marseille','Montpellier','Lyon']
ADJ['11'] = ['Nice','Avignon']
ADJ['12'] = ['Marseille']
ADJ['13'] = ['Avignon','Toulouse']
ADJ['14'] = ['Montpellier','Bordeaux','Limoges']
ADJ['15'] = ['Limoges','Toulouse','Nantes']
ADJ['16'] = ['Lyon','Toulouse','Bordeaux','Nantes','Paris']
ADJ['17'] = ['Limoges','Bordeaux','Rennes']
ADJ['18'] = ['Calais','Nancy','Dijon','Limoges','Rennes','Caen']
...
print(State.move(0))
print(DISTANCE[State.name][State.move(0).name])
print(DISTANCE[State.name][ADJ[State.name][0]])
print(ADJ[State.name][0])
